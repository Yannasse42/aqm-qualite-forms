    ...
    <div class="card" id="doc">
      <div class="header">
        ...
        <div class="brand">
          ...
          <div class="hgroup">
            <div class="title">QCM – Évaluation des connaissances (PRE FORMATION)</div>
...
// Auto-remplissage (même logique que POST)
...
document.getElementById("export").addEventListener("click", async () => {
  ...
  try {
    ...
    if (sections[0]) await addBlockToPdf(sections[0]); // identité

    // 2) questions (jamais coupées)
    const questions = clone.querySelectorAll(".q");
    for (const q of questions) {
      await addBlockToPdf(q);
    }

    // 3) remarques + signature
